...
namespace Drupal\paragraph_photo\Plugin\paragraphs\Behavior;
 ...
 * @ParagraphsBehavior(
 *   id = "paragraph_photo",
 *   label = @Translation("Photo display module"),
 *   description = @Translation("Allows to change photo position."),
 *   weight = 0,
 * )
 */
class paragraph_photo extends ParagraphsBehaviorBase
{
  /**
   * {@inheritdoc}
   */
  ...
  {
    if ($paragraphs_type->id() == 'photo_img') {
      return TRUE;
    }
    return FALSE;
  }
  ...
  public function view(array &$build, Paragraph $paragraph, EntityViewDisplayInterface $display, $view_mode)
  {
    ...
    if ($build['field_pimg']['#formatter'] == 'image') {
      switch ($image_size) {
        case '6_12':
          $build['field_pimg'][0]['#image_style'] = 'image_and_text_6_of_12';
          break;

        case '8_12':
          $build['field_pimg'][0]['#image_style'] = 'image_and_text_8_of_12';
          break;
      }
    }
  }
